...
export default function Chat({auth,messages, receiver, errors , recentMessages}) {
    useEffect(() => {
        setInterval(() => {
            router.reload({ only: ["receiver", "messages", "recentMessages"] });
        }, 3000);
    }, []);
    return (
        <AuthenticatedLayout  user={auth} errors={errors}>
            <div className="">
